...
```
cd existing_repo
git remote add origin https://gitlab.com/school104/programmeren-4-share-a-meal.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/school104/programmeren-4-share-a-meal/-/settings/integrations)
